...
\begin{equation*}
  T= \SI{2.2677\pm2145.6}{\micro\second}
\end{equation*}
abschätzen.
Der Fehler berechnet sich hier nach Gauß mit:
\begin{align*}
  \symup{\Delta} T ^2 = & (\frac{2N_1 N_2 - 2N_2(N_1 + N_2 - N_{1+2})}{2 N_1 N_2}^2)^2\Delta N_{1}^2 \\
  & +(\frac{2N_1 N_2 - 2N_1(N_1 + N_2 - N_{1+2})}{2 N_1 N_2}^2)^2\Delta N_{2}^2 \\
  & +(\frac{-1}{2 N_1 N_2})^2 \Delta N_{1+2}^2\\
\end{align*}
%
